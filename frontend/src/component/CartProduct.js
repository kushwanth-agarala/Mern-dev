  ...
  return (
    <div className='bg-slate-200 p-2 flex gap-4 rounded border-2 border-slate-300'>
     <div className='bg-white rounded overflow-hidden p-3'>
          <img src={image} className='h-28 w-40 object-cover ' alt='imageProfile'/>
     </div>
     <div className='flex flex-col gap-1 w-full'>
      ...
      <h3 className='font-semibold text-slate-600  capitalize text-lg md:text-xl'>{name}</h3>
        ...
        <p className='font-bold text-base  '><span className='text-red-500'>₹</span>{price}</p>
        <div className='flex justify-between '>
        ...
        <p className='font-semibold p-1 relative top-1 '>{qty}</p>
